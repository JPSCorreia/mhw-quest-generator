                ...
                <div className="qg-versus" key={st.weapon + st.monster + (rolling?'r':'')}>
                  <div className="qg-vs-face">
                    ...
                    <div className="qg-vs-portrait">
                      ...
                      {showWeapon && <img src={`../../assets/weapons/${showWeapon}.png`} alt="" style={{filter:"invert(1) drop-shadow(0 0 14px rgba(243,224,161,.4))"}}/>}
                    </div>
                  ...
                  <div className="qg-vs-face">
                    ...
                    <div className="qg-vs-portrait emerald">
                      <div className="frame-orn"></div>
                      {showMonster && <img src={`../../assets/monsters/${showMonster}.webp`} alt=""/>}
                    </div>
